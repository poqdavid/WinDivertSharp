...
public static unsafe class WinDivert
{
    ...
    /// </returns>
    public static bool WinDivertRecvEx(IntPtr handle, WinDivertBuffer packet, uint flags, ref WinDivertAddress address, ref uint readLen, NativeOverlapped* lpOverlapped)
    {
        fixed (WinDivertAddress* pAddress = &address)
        {
            fixed (uint* pReadLen = &readLen)
            {
                ...
                var result = WinDivertNative.WinDivertRecvEx(handle, packet.BufferPointer, (uint)packet.Length, 0, ref address, ref readLen, lpOverlapped);
    ...
    public static bool WinDivertSendEx(IntPtr handle, WinDivertBuffer packet, uint packetLength, ulong flags, ref WinDivertAddress address, ref uint sendLen, NativeOverlapped* lpOverlapped)
    {
        fixed (WinDivertAddress* pAddress = &address)
        {
            fixed (uint* pWriteLen = &sendLen)
            {
                var result = WinDivertNative.WinDivertSendEx(handle, packet.BufferPointer, (uint)packetLength, flags, ref address, ref sendLen, lpOverlapped);
