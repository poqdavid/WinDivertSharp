...
public static partial class Kernel32
{
    ...
    /// <returns>
    /// </returns>
    [LibraryImport("kernel32.dll", EntryPoint = "GetOverlappedResult", SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static unsafe partial bool GetOverlappedResult(IntPtr hFile, NativeOverlapped* lpOverlapped, ref uint lpNumberOfBytesTransferred, [MarshalAs(UnmanagedType.Bool)] bool bWait);
}