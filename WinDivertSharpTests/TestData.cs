...
internal class TestData : IDisposable
{
    ...
    public static WinDivertBuffer EchoRequestData = new(new byte[]
    {   
    ...
    public static WinDivertBuffer HttpRequestData = new(new byte[]
    {
    ...
    // IPV4 DNS REQUEST
    public static WinDivertBuffer DnsRequestData = new(new byte[]
    {
    ...
    // IPV6 TCP SYN
    public static WinDivertBuffer Ipv6TcpSynData = new(new byte[]
    {
    ...
    public static WinDivertBuffer Ipv6EchoReplyData = new(new byte[]
    {
    ...
    public static WinDivertBuffer Ipv6ExtHdrsUdpData = new(new byte[]
    {
